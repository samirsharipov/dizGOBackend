...
@Repository
public class SotuvRepository {

    private static final Logger logger = LoggerFactory.getLogger(SotuvRepository.class);
    private final JdbcTemplate jdbcTemplate;


    public SotuvRepository(JdbcTemplate jdbcTemplate) {
