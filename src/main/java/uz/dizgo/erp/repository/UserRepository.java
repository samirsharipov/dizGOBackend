...
import uz.dizgo.erp.payload.projections.UserProjection;
...
public interface UserRepository extends JpaRepository<User, UUID> {
    ...
    @Query("SELECT new uz.dizgo.erp.payload.MonthlyEmploymentDismissalReportDto" +
            "(COUNT(u.id), " +
    ...
    @Query("SELECT new uz.dizgo.erp.payload.projections.UserProjection(u.id, CONCAT(u.firstName, ' ', u.lastName)) " +
            "FROM users u " +
