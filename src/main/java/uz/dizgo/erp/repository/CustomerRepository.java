...
import uz.dizgo.erp.payload.CustomerGet;
import uz.dizgo.erp.payload.CustomerGetInfoDto;
import uz.dizgo.erp.payload.CustomerResponseDto;
import uz.dizgo.erp.payload.projections.InActiveUserProjection;
...
public interface CustomerRepository extends JpaRepository<Customer, UUID> {
    ...
    @Query("SELECT new uz.dizgo.erp.payload.CustomerGet(c.id, c.user.firstName, c.user.lastName) " +
    ...
    @Query("SELECT new uz.dizgo.erp.payload.CustomerResponseDto(c.id, c.name, " +
